...
The foundational layer of the DevM8 — a Bun-based TypeScript CLI that starts a background daemon (macOS launchd), manages a TOML config file, and runs a first-time setup wizard.
